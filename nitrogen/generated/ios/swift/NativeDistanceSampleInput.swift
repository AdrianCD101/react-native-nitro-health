...
public extension NativeDistanceSampleInput {
   ...
   */
  init(startTimeMs: Double, endTimeMs: Double, distanceMeters: Double, scope: NativeDistanceScope, device: NativeHealthDeviceInfo?, recordingMethod: NativeHealthRecordingMethod?, syncId: String?, syncVersion: Double?) {
    self.init(startTimeMs, endTimeMs, distanceMeters, scope, { () -> bridge.std__optional_NativeHealthDeviceInfo_ in
