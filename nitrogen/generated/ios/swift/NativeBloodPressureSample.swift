...
public extension NativeBloodPressureSample {
   ...
   */
  init(sampleMetadata: NativeHealthSampleMetadata, timeMs: Double, systolicMmHg: Double, diastolicMmHg: Double, androidBodyPosition: NativeBloodPressureBodyPosition?, androidMeasurementLocation: NativeBloodPressureMeasurementLocation?) {
    self.init(sampleMetadata, timeMs, systolicMmHg, diastolicMmHg, { () -> bridge.std__optional_NativeBloodPressureBodyPosition_ in
