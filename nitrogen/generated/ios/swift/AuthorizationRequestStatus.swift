...
/**
 * Represents the JS union `AuthorizationRequestStatus`, backed by a C++ enum.
 */
public typealias AuthorizationRequestStatus = margelo.nitro.nitrohealth.AuthorizationRequestStatus
