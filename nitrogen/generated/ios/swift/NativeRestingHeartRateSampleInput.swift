...
public extension NativeRestingHeartRateSampleInput {
   ...
   */
  init(timeMs: Double, bpm: Double, device: NativeHealthDeviceInfo?, recordingMethod: NativeHealthRecordingMethod?, syncId: String?, syncVersion: Double?) {
    self.init(timeMs, bpm, { () -> bridge.std__optional_NativeHealthDeviceInfo_ in
