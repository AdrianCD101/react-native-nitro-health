...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeDailyDistanceTotal).
   */
  struct NativeDailyDistanceTotal final {
  public:
  ...
  public:
    NativeDailyDistanceTotal() = default;
    explicit NativeDailyDistanceTotal(double startTimeMs, double endTimeMs, double distanceMeters): startTimeMs(startTimeMs), endTimeMs(endTimeMs), distanceMeters(distanceMeters) {}

  public:
    friend bool operator==(const NativeDailyDistanceTotal& lhs, const NativeDailyDistanceTotal& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeDailyDistanceTotal <> JS NativeDailyDistanceTotal (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeDailyDistanceTotal> final {
    static inline margelo::nitro::nitrohealth::NativeDailyDistanceTotal fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohealth::NativeDailyDistanceTotal(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeDailyDistanceTotal& arg) {
