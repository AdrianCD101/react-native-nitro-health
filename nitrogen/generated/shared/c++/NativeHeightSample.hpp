...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeightSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, double timeMs, double meters): identity(identity), origin(origin), timeMs(timeMs), meters(meters) {}
