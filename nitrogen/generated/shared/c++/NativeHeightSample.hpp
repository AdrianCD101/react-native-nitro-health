...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeightSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double timeMs, double meters): identity(identity), origin(origin), recordingMethod(recordingMethod), timeMs(timeMs), meters(meters) {}
