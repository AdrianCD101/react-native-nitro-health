...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeartRateSample(std::string uuid, std::string recordUuid, double timeMs, double bpm, std::optional<std::string> source): uuid(uuid), recordUuid(recordUuid), timeMs(timeMs), bpm(bpm), source(source) {}
