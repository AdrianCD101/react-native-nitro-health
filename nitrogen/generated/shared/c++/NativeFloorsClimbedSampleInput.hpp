...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeFloorsClimbedSampleInput(double startTimeMs, double endTimeMs, double floors, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), floors(floors), syncId(syncId), syncVersion(syncVersion) {}
