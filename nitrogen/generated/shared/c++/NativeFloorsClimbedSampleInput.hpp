...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeFloorsClimbedSampleInput(double startTimeMs, double endTimeMs, double floors, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), floors(floors), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
