...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeFloorsClimbedSampleInput(double startTimeMs, double endTimeMs, double floors, NativeHealthWriteMetadata writeMetadata): startTimeMs(startTimeMs), endTimeMs(endTimeMs), floors(floors), writeMetadata(writeMetadata) {}
