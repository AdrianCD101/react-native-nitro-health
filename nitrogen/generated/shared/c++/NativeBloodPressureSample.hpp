...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBloodPressureSample(NativeHealthSampleMetadata sampleMetadata, double timeMs, double systolicMmHg, double diastolicMmHg, std::optional<NativeBloodPressureBodyPosition> androidBodyPosition, std::optional<NativeBloodPressureMeasurementLocation> androidMeasurementLocation): sampleMetadata(sampleMetadata), timeMs(timeMs), systolicMmHg(systolicMmHg), diastolicMmHg(diastolicMmHg), androidBodyPosition(androidBodyPosition), androidMeasurementLocation(androidMeasurementLocation) {}
