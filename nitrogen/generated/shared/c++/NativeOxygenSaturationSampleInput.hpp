...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeOxygenSaturationSampleInput(double timeMs, double percentage, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), percentage(percentage), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
