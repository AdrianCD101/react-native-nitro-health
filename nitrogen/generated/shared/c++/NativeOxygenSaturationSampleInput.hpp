...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeOxygenSaturationSampleInput(double timeMs, double percentage, NativeHealthWriteMetadata writeMetadata): timeMs(timeMs), percentage(percentage), writeMetadata(writeMetadata) {}
