...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeOxygenSaturationSampleInput(double timeMs, double percentage, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), percentage(percentage), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
