...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeDistanceSample(NativeHealthSampleMetadata sampleMetadata, double startTimeMs, double endTimeMs, double distanceMeters, NativeDistanceScope scope): sampleMetadata(sampleMetadata), startTimeMs(startTimeMs), endTimeMs(endTimeMs), distanceMeters(distanceMeters), scope(scope) {}
