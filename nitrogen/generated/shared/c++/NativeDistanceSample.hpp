...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeDistanceSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double startTimeMs, double endTimeMs, double distanceMeters, NativeDistanceScope scope): identity(identity), origin(origin), recordingMethod(recordingMethod), startTimeMs(startTimeMs), endTimeMs(endTimeMs), distanceMeters(distanceMeters), scope(scope) {}
