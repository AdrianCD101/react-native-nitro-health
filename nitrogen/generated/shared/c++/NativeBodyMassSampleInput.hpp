...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyMassSampleInput(double timeMs, double kilograms, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), kilograms(kilograms), syncId(syncId), syncVersion(syncVersion) {}
