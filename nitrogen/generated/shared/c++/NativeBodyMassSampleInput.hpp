...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyMassSampleInput(double timeMs, double kilograms, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), kilograms(kilograms), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
