...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeightSampleInput(double timeMs, double meters, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), meters(meters), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
