...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeBodyFatSampleInput).
   */
  struct NativeBodyFatSampleInput final {
  public:
  ...
  public:
    NativeBodyFatSampleInput() = default;
    explicit NativeBodyFatSampleInput(double timeMs, double percentage, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), percentage(percentage), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}

  public:
    friend bool operator==(const NativeBodyFatSampleInput& lhs, const NativeBodyFatSampleInput& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeBodyFatSampleInput <> JS NativeBodyFatSampleInput (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeBodyFatSampleInput> final {
    static inline margelo::nitro::nitrohealth::NativeBodyFatSampleInput fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohealth::NativeBodyFatSampleInput(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeBodyFatSampleInput& arg) {
