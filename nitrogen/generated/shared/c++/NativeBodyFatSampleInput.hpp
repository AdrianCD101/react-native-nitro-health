...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyFatSampleInput(double timeMs, double percentage, NativeHealthWriteMetadata writeMetadata): timeMs(timeMs), percentage(percentage), writeMetadata(writeMetadata) {}
