...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeartRateSampleInput(double timeMs, double bpm, NativeHealthWriteMetadata writeMetadata): timeMs(timeMs), bpm(bpm), writeMetadata(writeMetadata) {}
