...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyMassSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double startTimeMs, double endTimeMs, double kilograms): identity(identity), origin(origin), recordingMethod(recordingMethod), startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilograms(kilograms) {}
