...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyMassSample(NativeHealthSampleMetadata sampleMetadata, double startTimeMs, double endTimeMs, double kilograms): sampleMetadata(sampleMetadata), startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilograms(kilograms) {}
