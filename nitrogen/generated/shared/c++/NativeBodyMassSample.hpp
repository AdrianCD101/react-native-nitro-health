...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyMassSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, std::optional<NativeHealthDeviceInfo> device, NativeHealthRecordingMethod recordingMethod, double startTimeMs, double endTimeMs, double kilograms): identity(identity), origin(origin), device(device), recordingMethod(recordingMethod), startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilograms(kilograms) {}
