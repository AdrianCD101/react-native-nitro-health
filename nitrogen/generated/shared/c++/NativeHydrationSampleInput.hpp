...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHydrationSampleInput(double startTimeMs, double endTimeMs, double milliliters, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), milliliters(milliliters), syncId(syncId), syncVersion(syncVersion) {}
