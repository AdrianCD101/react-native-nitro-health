...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHydrationSampleInput(double startTimeMs, double endTimeMs, double milliliters, NativeHealthWriteMetadata writeMetadata): startTimeMs(startTimeMs), endTimeMs(endTimeMs), milliliters(milliliters), writeMetadata(writeMetadata) {}
