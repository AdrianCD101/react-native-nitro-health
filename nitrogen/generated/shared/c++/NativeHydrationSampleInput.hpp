///
/// NativeHydrationSampleInput.hpp
...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeHydrationSampleInput).
   */
  struct NativeHydrationSampleInput final {
  public:
  ...
  public:
    NativeHydrationSampleInput() = default;
    explicit NativeHydrationSampleInput(double startTimeMs, double endTimeMs, double milliliters, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), milliliters(milliliters), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}

  public:
    friend bool operator==(const NativeHydrationSampleInput& lhs, const NativeHydrationSampleInput& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeHydrationSampleInput <> JS NativeHydrationSampleInput (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeHydrationSampleInput> final {
    static inline margelo::nitro::nitrohealth::NativeHydrationSampleInput fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohealth::NativeHydrationSampleInput(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeHydrationSampleInput& arg) {
