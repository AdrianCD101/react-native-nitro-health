///
/// NativeDailyActiveEnergyBurnedTotal.hpp
...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeDailyActiveEnergyBurnedTotal).
   */
  struct NativeDailyActiveEnergyBurnedTotal final {
  public:
  ...
  public:
    NativeDailyActiveEnergyBurnedTotal() = default;
    explicit NativeDailyActiveEnergyBurnedTotal(double startTimeMs, double endTimeMs, double kilocalories): startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilocalories(kilocalories) {}

  public:
    friend bool operator==(const NativeDailyActiveEnergyBurnedTotal& lhs, const NativeDailyActiveEnergyBurnedTotal& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeDailyActiveEnergyBurnedTotal <> JS NativeDailyActiveEnergyBurnedTotal (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeDailyActiveEnergyBurnedTotal> final {
    static inline margelo::nitro::nitrohealth::NativeDailyActiveEnergyBurnedTotal fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohealth::NativeDailyActiveEnergyBurnedTotal(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeDailyActiveEnergyBurnedTotal& arg) {
