...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeartRateVariabilitySample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double timeMs, double milliseconds, std::string method): identity(identity), origin(origin), recordingMethod(recordingMethod), timeMs(timeMs), milliseconds(milliseconds), method(method) {}
