...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHeartRateVariabilitySample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, std::optional<NativeHealthDeviceInfo> device, NativeHealthRecordingMethod recordingMethod, double timeMs, double milliseconds, std::string method): identity(identity), origin(origin), device(device), recordingMethod(recordingMethod), timeMs(timeMs), milliseconds(milliseconds), method(method) {}
