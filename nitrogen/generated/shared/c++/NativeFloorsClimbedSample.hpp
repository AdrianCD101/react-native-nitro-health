...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeFloorsClimbedSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, std::optional<NativeHealthDeviceInfo> device, NativeHealthRecordingMethod recordingMethod, double startTimeMs, double endTimeMs, double floors): identity(identity), origin(origin), device(device), recordingMethod(recordingMethod), startTimeMs(startTimeMs), endTimeMs(endTimeMs), floors(floors) {}
