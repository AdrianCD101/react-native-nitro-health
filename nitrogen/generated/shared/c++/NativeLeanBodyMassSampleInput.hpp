...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeLeanBodyMassSampleInput(double timeMs, double kilograms, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), kilograms(kilograms), syncId(syncId), syncVersion(syncVersion) {}
