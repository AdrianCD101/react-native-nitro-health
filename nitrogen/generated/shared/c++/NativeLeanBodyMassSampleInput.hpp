...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeLeanBodyMassSampleInput(double timeMs, double kilograms, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), kilograms(kilograms), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
