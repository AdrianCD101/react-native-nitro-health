...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeStepSampleInput(double startTimeMs, double endTimeMs, double count, NativeHealthWriteMetadata writeMetadata): startTimeMs(startTimeMs), endTimeMs(endTimeMs), count(count), writeMetadata(writeMetadata) {}
