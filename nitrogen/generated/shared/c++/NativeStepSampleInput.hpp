...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeStepSampleInput(double startTimeMs, double endTimeMs, double count, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), count(count), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
