...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeStepSampleInput).
   */
  struct NativeStepSampleInput final {
  public:
  ...
  public:
    NativeStepSampleInput() = default;
    explicit NativeStepSampleInput(double startTimeMs, double endTimeMs, double count, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), count(count), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}

  public:
    friend bool operator==(const NativeStepSampleInput& lhs, const NativeStepSampleInput& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeStepSampleInput <> JS NativeStepSampleInput (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeStepSampleInput> final {
    static inline margelo::nitro::nitrohealth::NativeStepSampleInput fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohealth::NativeStepSampleInput(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeStepSampleInput& arg) {
