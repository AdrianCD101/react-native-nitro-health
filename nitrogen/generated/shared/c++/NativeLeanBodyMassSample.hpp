...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeLeanBodyMassSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, double timeMs, double kilograms): identity(identity), origin(origin), timeMs(timeMs), kilograms(kilograms) {}
