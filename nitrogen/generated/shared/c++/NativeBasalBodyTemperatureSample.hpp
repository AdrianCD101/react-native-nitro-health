///
/// NativeBasalBodyTemperatureSample.hpp
...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeBasalBodyTemperatureSample).
   */
  struct NativeBasalBodyTemperatureSample final {
  public:
...
namespace margelo::nitro {
  ...
  // C++ NativeBasalBodyTemperatureSample <> JS NativeBasalBodyTemperatureSample (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeBasalBodyTemperatureSample> final {
    static inline margelo::nitro::nitrohealth::NativeBasalBodyTemperatureSample fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
