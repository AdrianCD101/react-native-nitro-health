...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRestingHeartRateSampleInput(double timeMs, double bpm, std::optional<NativeHealthDeviceInfo> device, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), bpm(bpm), device(device), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
