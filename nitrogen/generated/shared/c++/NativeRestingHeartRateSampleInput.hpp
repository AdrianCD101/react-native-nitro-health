...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRestingHeartRateSampleInput(double timeMs, double bpm, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), bpm(bpm), syncId(syncId), syncVersion(syncVersion) {}
