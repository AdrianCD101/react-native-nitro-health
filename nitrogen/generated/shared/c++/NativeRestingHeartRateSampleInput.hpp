...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRestingHeartRateSampleInput(double timeMs, double bpm, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), bpm(bpm), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
