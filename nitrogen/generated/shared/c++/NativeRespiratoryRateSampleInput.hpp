...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRespiratoryRateSampleInput(double timeMs, double breathsPerMinute, NativeHealthWriteMetadata writeMetadata): timeMs(timeMs), breathsPerMinute(breathsPerMinute), writeMetadata(writeMetadata) {}
