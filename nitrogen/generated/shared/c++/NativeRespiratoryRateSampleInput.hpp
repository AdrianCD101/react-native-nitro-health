///
/// NativeRespiratoryRateSampleInput.hpp
...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeRespiratoryRateSampleInput).
   */
  struct NativeRespiratoryRateSampleInput final {
  public:
  ...
  public:
    ...
    explicit NativeRespiratoryRateSampleInput(double timeMs, double breathsPerMinute, std::optional<std::string> syncId, std::optional<double> syncVersion): timeMs(timeMs), breathsPerMinute(breathsPerMinute), syncId(syncId), syncVersion(syncVersion) {}
...
namespace margelo::nitro {
  ...
  // C++ NativeRespiratoryRateSampleInput <> JS NativeRespiratoryRateSampleInput (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeRespiratoryRateSampleInput> final {
    static inline margelo::nitro::nitrohealth::NativeRespiratoryRateSampleInput fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeRespiratoryRateSampleInput& arg) {
