...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeActiveEnergyBurnedSampleInput(double startTimeMs, double endTimeMs, double kilocalories, std::optional<NativeHealthRecordingMethod> recordingMethod, std::optional<std::string> syncId, std::optional<double> syncVersion): startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilocalories(kilocalories), recordingMethod(recordingMethod), syncId(syncId), syncVersion(syncVersion) {}
