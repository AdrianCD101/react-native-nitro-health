...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeActiveEnergyBurnedSampleInput(double startTimeMs, double endTimeMs, double kilocalories, NativeHealthWriteMetadata writeMetadata): startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilocalories(kilocalories), writeMetadata(writeMetadata) {}
