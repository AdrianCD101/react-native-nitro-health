...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeOxygenSaturationSample(NativeHealthSampleMetadata sampleMetadata, double timeMs, double percentage): sampleMetadata(sampleMetadata), timeMs(timeMs), percentage(percentage) {}
