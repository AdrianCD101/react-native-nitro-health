...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRestingHeartRateSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double timeMs, double bpm): identity(identity), origin(origin), recordingMethod(recordingMethod), timeMs(timeMs), bpm(bpm) {}
