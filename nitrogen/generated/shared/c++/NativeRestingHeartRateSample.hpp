...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRestingHeartRateSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, std::optional<NativeHealthDeviceInfo> device, NativeHealthRecordingMethod recordingMethod, double timeMs, double bpm): identity(identity), origin(origin), device(device), recordingMethod(recordingMethod), timeMs(timeMs), bpm(bpm) {}
