...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRestingHeartRateSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, double timeMs, double bpm): identity(identity), origin(origin), timeMs(timeMs), bpm(bpm) {}
