...
namespace margelo::nitro::nitrohealth {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NativeBodyFatSample).
   */
  struct NativeBodyFatSample final {
  public:
  ...
  public:
    NativeBodyFatSample() = default;
    explicit NativeBodyFatSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, std::optional<NativeHealthDeviceInfo> device, NativeHealthRecordingMethod recordingMethod, double timeMs, double percentage): identity(identity), origin(origin), device(device), recordingMethod(recordingMethod), timeMs(timeMs), percentage(percentage) {}

  public:
    friend bool operator==(const NativeBodyFatSample& lhs, const NativeBodyFatSample& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NativeBodyFatSample <> JS NativeBodyFatSample (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrohealth::NativeBodyFatSample> final {
    static inline margelo::nitro::nitrohealth::NativeBodyFatSample fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrohealth::NativeBodyFatSample(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrohealth::NativeBodyFatSample& arg) {
