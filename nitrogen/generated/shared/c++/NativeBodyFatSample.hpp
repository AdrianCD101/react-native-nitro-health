...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyFatSample(NativeHealthSampleMetadata sampleMetadata, double timeMs, double percentage): sampleMetadata(sampleMetadata), timeMs(timeMs), percentage(percentage) {}
