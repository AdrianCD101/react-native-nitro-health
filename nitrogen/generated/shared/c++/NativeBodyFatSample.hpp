...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyFatSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, double timeMs, double percentage): identity(identity), origin(origin), timeMs(timeMs), percentage(percentage) {}
