...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeBodyFatSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double timeMs, double percentage): identity(identity), origin(origin), recordingMethod(recordingMethod), timeMs(timeMs), percentage(percentage) {}
