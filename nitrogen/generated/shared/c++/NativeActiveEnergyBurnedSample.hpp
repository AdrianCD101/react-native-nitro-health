...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeActiveEnergyBurnedSample(NativeHealthSampleMetadata sampleMetadata, double startTimeMs, double endTimeMs, double kilocalories): sampleMetadata(sampleMetadata), startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilocalories(kilocalories) {}
