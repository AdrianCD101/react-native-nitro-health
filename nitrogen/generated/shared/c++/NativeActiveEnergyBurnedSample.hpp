...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeActiveEnergyBurnedSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double startTimeMs, double endTimeMs, double kilocalories): identity(identity), origin(origin), recordingMethod(recordingMethod), startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilocalories(kilocalories) {}
