...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeActiveEnergyBurnedSample(double startTimeMs, double endTimeMs, double kilocalories): startTimeMs(startTimeMs), endTimeMs(endTimeMs), kilocalories(kilocalories) {}
