...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHydrationSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, double startTimeMs, double endTimeMs, double milliliters): identity(identity), origin(origin), startTimeMs(startTimeMs), endTimeMs(endTimeMs), milliliters(milliliters) {}
