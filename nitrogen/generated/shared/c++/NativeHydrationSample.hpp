...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeHydrationSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, NativeHealthRecordingMethod recordingMethod, double startTimeMs, double endTimeMs, double milliliters): identity(identity), origin(origin), recordingMethod(recordingMethod), startTimeMs(startTimeMs), endTimeMs(endTimeMs), milliliters(milliliters) {}
