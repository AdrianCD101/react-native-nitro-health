...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRespiratoryRateSample(NativeHealthSampleMetadata sampleMetadata, double timeMs, double breathsPerMinute): sampleMetadata(sampleMetadata), timeMs(timeMs), breathsPerMinute(breathsPerMinute) {}
