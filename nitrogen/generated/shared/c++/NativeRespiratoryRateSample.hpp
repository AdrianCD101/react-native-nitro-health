...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    explicit NativeRespiratoryRateSample(NativeHealthSampleIdentity identity, NativeHealthDataOrigin origin, std::optional<NativeHealthDeviceInfo> device, NativeHealthRecordingMethod recordingMethod, double timeMs, double breathsPerMinute): identity(identity), origin(origin), device(device), recordingMethod(recordingMethod), timeMs(timeMs), breathsPerMinute(breathsPerMinute) {}
