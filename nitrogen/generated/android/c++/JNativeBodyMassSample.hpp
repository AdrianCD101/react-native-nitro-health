...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeBodyMassSample::javaobject> fromCpp(const NativeBodyMassSample& value) {
      using JSignature = JNativeBodyMassSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double, double);
      static const auto clazz = javaClassStatic();
