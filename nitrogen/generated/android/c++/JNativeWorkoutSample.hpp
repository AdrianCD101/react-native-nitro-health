...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeWorkoutSample::javaobject> fromCpp(const NativeWorkoutSample& value) {
      using JSignature = JNativeWorkoutSample(jni::alias_ref<JNativeHealthSampleMetadata>, double, double, double, jni::alias_ref<JNativeHealthMetricValue>, jni::alias_ref<JNativeWorkoutActivity>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<JNativeHealthMetricValue>, jni::alias_ref<JNativeHealthMetricValue>);
      static const auto clazz = javaClassStatic();
