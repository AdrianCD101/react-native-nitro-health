...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeBodyFatSampleInput::javaobject> fromCpp(const NativeBodyFatSampleInput& value) {
      using JSignature = JNativeBodyFatSampleInput(double, double, jni::alias_ref<JNativeHealthRecordingMethod>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
