...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeStepSampleInput::javaobject> fromCpp(const NativeStepSampleInput& value) {
      using JSignature = JNativeStepSampleInput(double, double, double, jni::alias_ref<JNativeHealthRecordingMethod>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
