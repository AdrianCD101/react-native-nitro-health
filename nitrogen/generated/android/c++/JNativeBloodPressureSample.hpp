...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeBloodPressureSample::javaobject> fromCpp(const NativeBloodPressureSample& value) {
      using JSignature = JNativeBloodPressureSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double, double, jni::alias_ref<JNativeBloodPressureBodyPosition>, jni::alias_ref<JNativeBloodPressureMeasurementLocation>);
      static const auto clazz = javaClassStatic();
