...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeBodyTemperatureSample::javaobject> fromCpp(const NativeBodyTemperatureSample& value) {
      using JSignature = JNativeBodyTemperatureSample(jni::alias_ref<JNativeHealthSampleMetadata>, double, double, jni::alias_ref<JNativeAndroidBodyTemperatureMeasurementLocation>, jni::alias_ref<JNativeIOSBodyTemperatureSensorLocation>);
      static const auto clazz = javaClassStatic();
