...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeHeartRateSample::javaobject> fromCpp(const NativeHeartRateSample& value) {
      using JSignature = JNativeHeartRateSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthDeviceInfo>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double);
      static const auto clazz = javaClassStatic();
