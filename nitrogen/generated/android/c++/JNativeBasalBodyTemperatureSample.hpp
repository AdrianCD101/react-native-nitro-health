...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeBasalBodyTemperatureSample::javaobject> fromCpp(const NativeBasalBodyTemperatureSample& value) {
      using JSignature = JNativeBasalBodyTemperatureSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, double, double, jni::alias_ref<JNativeAndroidBodyTemperatureMeasurementLocation>, jni::alias_ref<JNativeIOSBodyTemperatureSensorLocation>);
      static const auto clazz = javaClassStatic();
