...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeActiveEnergyBurnedSample::javaobject> fromCpp(const NativeActiveEnergyBurnedSample& value) {
      using JSignature = JNativeActiveEnergyBurnedSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthDeviceInfo>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double, double);
      static const auto clazz = javaClassStatic();
