...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeOxygenSaturationSampleInput::javaobject> fromCpp(const NativeOxygenSaturationSampleInput& value) {
      using JSignature = JNativeOxygenSaturationSampleInput(double, double, jni::alias_ref<JNativeHealthRecordingMethod>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
