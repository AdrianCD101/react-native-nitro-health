...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeFloorsClimbedSample::javaobject> fromCpp(const NativeFloorsClimbedSample& value) {
      using JSignature = JNativeFloorsClimbedSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double, double);
      static const auto clazz = javaClassStatic();
