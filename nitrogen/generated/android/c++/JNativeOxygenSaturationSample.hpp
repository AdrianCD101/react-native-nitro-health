...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeOxygenSaturationSample::javaobject> fromCpp(const NativeOxygenSaturationSample& value) {
      using JSignature = JNativeOxygenSaturationSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double);
      static const auto clazz = javaClassStatic();
