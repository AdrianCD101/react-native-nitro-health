...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeBodyFatSample::javaobject> fromCpp(const NativeBodyFatSample& value) {
      using JSignature = JNativeBodyFatSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double);
      static const auto clazz = javaClassStatic();
