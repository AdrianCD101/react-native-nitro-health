...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeStepSample::javaobject> fromCpp(const NativeStepSample& value) {
      using JSignature = JNativeStepSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double, double);
      static const auto clazz = javaClassStatic();
