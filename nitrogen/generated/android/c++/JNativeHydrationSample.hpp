...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeHydrationSample::javaobject> fromCpp(const NativeHydrationSample& value) {
      using JSignature = JNativeHydrationSample(jni::alias_ref<JNativeHealthSampleIdentity>, jni::alias_ref<JNativeHealthDataOrigin>, jni::alias_ref<JNativeHealthRecordingMethod>, double, double, double);
      static const auto clazz = javaClassStatic();
