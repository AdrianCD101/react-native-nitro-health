...
namespace margelo::nitro::nitrohealth {
  ...
  public:
    ...
    static jni::local_ref<JNativeActiveEnergyBurnedSampleInput::javaobject> fromCpp(const NativeActiveEnergyBurnedSampleInput& value) {
      using JSignature = JNativeActiveEnergyBurnedSampleInput(double, double, double, jni::alias_ref<JNativeHealthDeviceInfo>, jni::alias_ref<JNativeHealthRecordingMethod>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>);
      static const auto clazz = javaClassStatic();
