...
data class NativeActiveEnergyBurnedSample(
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(startTimeMs: Double, endTimeMs: Double, kilocalories: Double): NativeActiveEnergyBurnedSample {
      return NativeActiveEnergyBurnedSample(startTimeMs, endTimeMs, kilocalories)
    }
  }
}
