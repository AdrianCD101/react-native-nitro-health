...
data class NativeHeartRateSample(
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(identity: NativeHealthSampleIdentity, origin: NativeHealthDataOrigin, device: NativeHealthDeviceInfo?, recordingMethod: NativeHealthRecordingMethod, timeMs: Double, bpm: Double): NativeHeartRateSample {
      return NativeHeartRateSample(identity, origin, device, recordingMethod, timeMs, bpm)
    }
  }
}
