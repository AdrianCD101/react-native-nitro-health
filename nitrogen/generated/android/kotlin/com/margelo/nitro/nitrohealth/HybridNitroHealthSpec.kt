...
abstract class HybridNitroHealthSpec: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  abstract fun readHydration(query: NativeHealthDateRangeQuery): Promise<NativeHydrationSamplePage>
  
  @DoNotStrip
  @Keep
  abstract fun readFloorsClimbed(query: NativeHealthDateRangeQuery): Promise<NativeFloorsClimbedSamplePage>
  ...
  @DoNotStrip
  @Keep
  abstract fun readBodyFat(query: NativeHealthDateRangeQuery): Promise<NativeBodyFatSamplePage>
  
  @DoNotStrip
  @Keep
  abstract fun readLeanBodyMass(query: NativeHealthDateRangeQuery): Promise<NativeLeanBodyMassSamplePage>
  
  @DoNotStrip
  @Keep
  abstract fun readBasalBodyTemperature(query: NativeHealthDateRangeQuery): Promise<NativeBasalBodyTemperatureSamplePage>
