...
data class NativeRestingHeartRateSample(
  ...
  companion object {
    ...
    @Suppress("unused")
    @JvmStatic
    private fun fromCpp(identity: NativeHealthSampleIdentity, origin: NativeHealthDataOrigin, device: NativeHealthDeviceInfo?, recordingMethod: NativeHealthRecordingMethod, timeMs: Double, bpm: Double): NativeRestingHeartRateSample {
      return NativeRestingHeartRateSample(identity, origin, device, recordingMethod, timeMs, bpm)
    }
  }
}
